...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('p-3 bg-base-100', className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:bg-secondary'
        ),
        ...
        day_outside:
          'day-outside opacity-50 aria-selected:bg-secondary/50 aria-selected:text-muted-foreground aria-selected:opacity-30',
